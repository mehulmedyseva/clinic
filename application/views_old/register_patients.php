                               ...
                               <div class="col-12 mb-2">
                                    <div class="form-group">
                                        <label><?php echo trans('phone') ?></label>
                                                                                <input type="text" class="form-control" name="mobile" placeholder="<?php echo trans('your-phone') ?>" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" pattern="\d{10}" maxlength="10" required>
