        ...
        <div class="row">
            <?php if (empty($code)): ?>
                <div class="col-md-12 text-center">
                    ...
                    <p class="mt-2"><?php echo trans('verify-email-sent-link') ?></p>
                </div>
            <?php else: ?>
                <?php if ($code == 'invalid'): ?>
                    <div class="col-md-12 text-center">
                        ...
                        <p class="mt-2"><?php echo trans('email-verification-failed') ?></p>

                        <a class="custom-btn custom-btn--medium custom-btn--style-2" href="<?php echo base_url() ?>"><?php echo trans('back-to-home') ?></a>
                    </div>
                <?php else: ?>
                    <div class="col-md-12 text-center">
