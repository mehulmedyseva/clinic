                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <div class="input-group mb-3">
                      <input type="text" class="form-control datepicker" required onchange="select_dob();" name="dob"  id="dob"  value="<?php echo html_escape($patients[0]['dob']); ?>" autocomplete="off">
